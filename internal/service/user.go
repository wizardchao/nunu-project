...
type UserService interface {
	...
	GetList(ctx context.Context, page int, pageSize int, options ...repository.UserOptions) ([]*model.User, error)
}
...
func (s userService) GetList(ctx context.Context, page int, pageSize int, options ...repository.UserOptions) (userList []*model.User, err error) {
	userRepo := s.userRepo
	userList, err = userRepo.GetList(ctx, page, pageSize, options...)
	if err != nil {
		err = errors.Wrap(err, "failed to getList")
	}
